...
public class CkCrypt2 {
  ...
  public boolean HashBdENC(SWIGTYPE_p_CkBinData bd, CkString outStr) {
    return chilkatJNI.CkCrypt2_HashBdENC(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(bd), CkString.getCPtr(outStr), outStr);
  }

  public String hashBdENC(SWIGTYPE_p_CkBinData bd) {
    return chilkatJNI.CkCrypt2_hashBdENC(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(bd));
  }
  ...
  public boolean MacBdENC(SWIGTYPE_p_CkBinData bd, CkString outStr) {
    return chilkatJNI.CkCrypt2_MacBdENC(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(bd), CkString.getCPtr(outStr), outStr);
  }

  public String macBdENC(SWIGTYPE_p_CkBinData bd) {
    return chilkatJNI.CkCrypt2_macBdENC(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(bd));
  }
