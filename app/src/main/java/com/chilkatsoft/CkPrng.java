...
public class CkPrng {
  ...
  public boolean GenRandomBd(int numBytes, SWIGTYPE_p_CkBinData bd) {
    return chilkatJNI.CkPrng_GenRandomBd(swigCPtr, this, numBytes, SWIGTYPE_p_CkBinData.getCPtr(bd));
  }
