...
public class CkJwe {
  ...
  public boolean DecryptBd(int index, SWIGTYPE_p_CkBinData bd) {
    return chilkatJNI.CkJwe_DecryptBd(swigCPtr, this, index, SWIGTYPE_p_CkBinData.getCPtr(bd));
  }
  ...
  public boolean EncryptBd(SWIGTYPE_p_CkBinData contentBd, CkStringBuilder jweSb) {
    return chilkatJNI.CkJwe_EncryptBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(contentBd), CkStringBuilder.getCPtr(jweSb), jweSb);
  }
  ...
  public boolean SetAadBd(SWIGTYPE_p_CkBinData aad) {
    return chilkatJNI.CkJwe_SetAadBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(aad));
  }
