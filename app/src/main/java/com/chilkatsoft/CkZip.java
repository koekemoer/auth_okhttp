...
public class CkZip {
  ...
  public boolean OpenBd(SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkZip_OpenBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }
  ...
  public boolean WriteBd(SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkZip_WriteBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask WriteBdAsync(SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkZip_WriteBdAsync(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
