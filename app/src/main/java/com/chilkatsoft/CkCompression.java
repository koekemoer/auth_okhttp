...
public class CkCompression {
  ...
  public boolean CompressBd(SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkCompression_CompressBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask CompressBdAsync(SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkCompression_CompressBdAsync(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean DecompressBd(SWIGTYPE_p_CkBinData binData) {
    return chilkatJNI.CkCompression_DecompressBd(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
  }

  public CkTask DecompressBdAsync(SWIGTYPE_p_CkBinData binData) {
    long cPtr = chilkatJNI.CkCompression_DecompressBdAsync(swigCPtr, this, SWIGTYPE_p_CkBinData.getCPtr(binData));
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
